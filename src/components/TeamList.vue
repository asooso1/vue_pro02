<template>
    ...
    <v-card class="mx-auto" width="300">
      <v-list>
        ...
        <v-list-group v-for="(item, i) in parentData" v-model="item.group_nm" :key="i" :value="true"
          ...
          <v-list-group v-for="(subItem, i) in childData" v-model="subItem.group_nm" :key="i" :value="true" no-action
            sub-group>
            <template v-slot:activator>
              <v-list-item-content>
